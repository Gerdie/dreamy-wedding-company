...
jQuery(document).ready(function($) {
	...
	$('#dwd-fp-1').on({
        'mouseenter': function(){
            $('#dwd-fp-1').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/hover1.png');
	...
	$('#dwd-fp-1').on({
        'mouseleave': function(){
            $('#dwd-fp-1').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/boutonniere-300sq.jpg');
	...
	$('#dwd-fp-2').on({
        'mouseenter': function(){
            $('#dwd-fp-2').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/hover2.png');
	...
	$('#dwd-fp-2').on({
        'mouseleave': function(){
            $('#dwd-fp-2').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/ceremony-300sq.jpg');
	...
	$('#dwd-fp-3').on({
        'mouseenter': function(){
            $('#dwd-fp-3').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/hover3.png');
	...
	$('#dwd-fp-3').on({
        'mouseleave': function(){
            $('#dwd-fp-3').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/bouquet-pw-300sq.jpg');
	...
	$('#dwd-fp-4').on({
        'mouseenter': function(){
            $('#dwd-fp-4').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/hover4.png');
	...
	$('#dwd-fp-4').on({
        'mouseleave': function(){
            $('#dwd-fp-4').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/cake-top-300sq.jpg');
	...
	$('#dwd-fp-5').on({
        'mouseenter': function(){
            $('#dwd-fp-5').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/hover5.png');
	...
	$('#dwd-fp-5').on({
        'mouseleave': function(){
            $('#dwd-fp-5').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/shoes-300sq.jpg');
	...
	$('#dwd-fp-6').on({
        'mouseenter': function(){
            $('#dwd-fp-6').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/hover6.png');
	...
	$('#dwd-fp-6').on({
        'mouseleave': function(){
            $('#dwd-fp-6').attr('src','http://www.dreamyweddingcompany.com/wp-content/uploads/2016/05/white-bout-300sq.jpg');
