...
class Scaffolding_Editor_Styles {
    ...
    public function style_formats( $settings ) {
        ...
        $style_formats = array(
            array(
                'title'    => __( 'Button', 'bouquets-boutonnieres-more' ),
                'selector' => 'a',
                'classes'  => 'button',
                'exact'    => true
            ),
            array(
                'title' => __( 'Lead Paragraph', 'bouquets-boutonnieres-more' ),
                'selector' => 'p',
                'classes' => 'lead'
            ),
            array(
                'title'  => __( 'Label', 'bouquets-boutonnieres-more' ),
                'inline' => 'span',
                'classes'=> 'label'
            ),
            array(
                'title'   => __( 'Panel', 'bouquets-boutonnieres-more' ),
                'block'   => 'div',
                'classes' => 'panel',
                'wrapper' => true
            ),
            array(
                'title'   => __( 'Panel callout', 'bouquets-boutonnieres-more' ),
                'block'   => 'div',
            ...
            array(
                'title'    => __( 'Radius (Panel, Label, Button)', 'bouquets-boutonnieres-more' ),
                'selector' => 'a.button, span.label, div.panel, div.panel.callout',
                'classes'  => 'radius'
            ),

            array(
                'title'    => __( 'Round (Label, Button)', 'bouquets-boutonnieres-more' ),
                'selector' => 'a.button, span.label',
                'classes'  => 'round'
            ),

            array(
                'title'    => __( 'Alert (Label, Button)', 'bouquets-boutonnieres-more' ),
                'selector' => 'a.button, span.label',
                'classes'  => 'alert'
            ),
            array(
                'title'    => __( 'Success (Label, Button)', 'bouquets-boutonnieres-more' ),
                'selector' => 'a.button, span.label',
                'classes'  => 'success'
            ),
            array(
                'title'    => __( 'Secondary (Label, Button)', 'bouquets-boutonnieres-more' ),
                'selector' => 'a.button, span.label',
                'classes'  => 'secondary'
            ),
            array(
                'title'    => __( 'Subheader (Headings)', 'bouquets-boutonnieres-more' ),
                'selector' => 'h1, h2, h3, h4, h5, h6',
                'classes'  => 'subheader'
            ),
            array(
                'title'  => __( 'Keyboard CMD', 'bouquets-boutonnieres-more' ),
                'inline' => 'kbd'
            )
        );

        // Let devs get a chance to remove and change that stuff.
        $settings['style_formats'] = json_encode( apply_filters( 'bouquets_boutonnieres_more_editor_stlye_args', $style_formats ) );
