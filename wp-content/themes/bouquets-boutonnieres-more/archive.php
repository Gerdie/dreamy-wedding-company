			...
			<?php while (have_posts()) : the_post(); ?>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header class="article-header">
							...
							<?php
							/* Hidden by default
							<?php printf(__('Posted <time class="updated" datetime="%1$s" pubdate>%2$s</time> by <span class="author">%3$s</span> <span class="amp">&</span> filed under %4$s.', 'bouquets-boutonnieres-more'), get_the_time('Y-m-j'), get_the_time(get_option('date_format')), bouquets_boutonnieres_more_get_the_author_posts_link(), get_the_category_list(', ')); ?></p>
							*/ ?>
						...
						<section class="entry-content clearfix">
							...
							<?php the_post_thumbnail( 'bouquets-boutonnieres-more-thumb-300' ); ?>
