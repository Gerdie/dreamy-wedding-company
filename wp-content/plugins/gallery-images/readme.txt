...
**[Demo 1 image gallery Gallery /Content Popup](http://huge-it.com/wordpress-plugins-gallery-demo/#plugin_demo_wrapper)**

In this gallery each post with the picture, title under text open in popup and make them larger. The button “View more” is under the text also inside the popup, it opens more information about the content in gallery. to close the popup press “cross” button and go back to the tape.

**[Demo 2 Image gallery Content slider](http://huge-it.com/wordpress-gallery-demo-2-content-slider/#plugin_demo_wrapper)**
...
**[Demo 3 Image gallery Lightbox Gallery](http://huge-it.com/wordpress-gallery-demo-3-lightbox-gallery/#plugin_demo_wrapper)**

In this gallery view you can add only the images of images without text. The title comes up from the bottom of the image as you hover the mouse on it in imge gallery. Images become larger with the lightbox and you can slide to watch them on gallery.

**[Demo 4 Image gallery Slideshow](http://huge-it.com/wordpress-gallery-demo-4-slideshow/#plugin_demo_wrapper)**

If you have seen Huge-IT Slider you will see this view is the same on image gallery, in gallery your picture with its title and description on the image, moves with many beautiful effects as you click on arrows.

**[Demo 5 Image gallery thumbnails gallery](http://huge-it.com/wordpress-gallery-demo-5-thumbnails/#plugin_demo_wrapper)**

This view shows your images like thumbnail gallery. As you click they open in lightbox on gallery, and you can scroll them. there is not any text with it, only it’s title.
...
**[Demo 7 Image gallery Blog Style View](http://huge-it.com/wordpress-gallery-demo-7-blog-style-view/#plugin_demo_wrapper)**
...
77.  [WordPress Image Gallery](http://wordpress.org/plugins/gallery-images/) - Image Gallery General options
...
=How to add Images, Title, Description, URL into the gallery?=
 
Add Images into the gallery: Use the standard WordPress Image uploader to add an image from Media Library or upload from your computer into the Image Gallery plugin

Add title for the gallery images: Give titles  to your gallery  images and videos  in the Image Gallery plugin

Add description for the gallery images: Give some information or describe your gallery images  in  Image Gallery plugin

Add URL in the gallery: Provide some links for your gallery images. In Image Gallery plugin click to “Open In New Tab” or not  to open in the same tab your gallery images

=How to add Video, Title, Description, URL into the gallery?=

Add Videos in the gallery: Use the standard WordPress video uploader to add a video from Youtube or Vimeo. Just insert the link of your videos into the Image Gallery plugin

Add title for the gallery videos: In Image gallery plugin give  titles to your gallery videos

Add description for the gallery videos: Add some information or describe your videos in Image Gallery plugin

Add URL in the gallery: Provide some links for your gallery videos. n Image Gallery plugin

click to “Open In New Tab” or not to open in the same tab your videos 

=Insert Gallery into WordPress Post/Page= 
...
Displaying Content: Select how to show the gallery, per page, load more or show all

Ratings for the gallery: Need to rate your gallery images/videos then activate Like/Dislike or Heart button

Usage:

Shortcode: Here find a shortcode of your Image Gallery. You can Copy and Paste this shortcode of gallery wherever you need in your WordPress posts or page to be. Or you can add this code automatically, when posting your Image Gallery there is a button to Add Gallery, pressing on it the shortcode inserts into your post.
...
=General Options of Image Gallery=

General Options are available for commercial version users. With the help of Image Gallery General Options, you can do more things. Change font colors, font size, background color, Overlay color, element width and height and many more customization  for the gallery.
...
Element Width: Set the width for the  posted images of the gallery

Element Height: Set the height for the  posted images of the gallery

Element Border Width: Set the for the gallery images border width 

Element Border Color: Choose the color for the gallery image border 

Element's Image Overlay Color: Choose a color for the overlay on the image while hovering on the image  in Image Gallery plugin

Element's Image Overlay Transparency: Set the level of transparency for the gallery image overlay
...
Popup Close Button Style: Change the color of “X” icon on the images of the gallery			

Show Separator Lines: Tick to show separator lines between title and text in popup for the images of the gallery
...
Description Font Size: Choose the size of description font for the gallery images

Description Font Color: Change the color of description text  for the gallery images
...
Element Title Background Color: Choose the color of title background in your gallery images

Element Title Font Color: Change the title font color of the gallery images 


*    **Element Link Button of Image Gallery**

Show Link Button On Element:  Tick to show “View More” button on the images of your gallery

Link Button Text: Change content of the “View More” text in Gallery plugin

Link Button Font Size: Change the font size of the link button on the images of the gallery

Link Button Font Color: In the gallery change the font color of the link 

Link Button Background Color: In the gallery choose the background  color for the link 


*  **Popup Title of Image Gallery**


Popup Title Font Size: Choose Title font size for the gallery images 

Popup Title Font Color: Choose Title font color for the gallery images 
...
Link Button Font Color: Change font color of the  link button in popup of the gallery images

Link Button Font Hover Color: Choose font color of the link button when hover on it for the gallery images

Link Button Background Color: In gallery set background color of the link button in popup 

Link Button Background Hover Color: Set background color of the link as you hover on image


*   **Ratings Styles**

Show Ratings Count: Tick to show ratings count for your gallery images/videos  

Ratings Background Color: Choose to set ratings background color on images of your gallery

Ratings Background Color Transparency: Set the level of ratings background color transparency on images or videos of your gallery

Ratings Font Color: Choose the ratings font color 

Ratings Rated Font Color: Choose the ratings rated  font color 

Like/Dislike Icon Color: Set Like/Dislike icon color on the images of the gallery

Like/Dislike Rated Icon Color: Set Like/Dislike rated icon color  on the images of the gallery

Heart Icon Color: Set Hearst icon color on the images of the gallery

Heart Rated Icon Color: Set Heart rated  icon color on the images of the gallery


*   **Pagination Styles**

Pagination Font Size: Set the font size for the pagination of the gallery images/videos

Pagination Font Color: Set the font color of the pagination for the gallery 

Pagination Icons Size: Set the size of the pagination icon for the gallery

Pagination Icons Color: In gallery set the size for the pagination icon color 
...
Load More Text: Write whatever you need in this section 

Load More Position: Choose Load More position among Right, Left, Center for the images of the gallery

Load More Font Size: For the gallery set the font size of the Load More 

Load More Font Color: For the gallery set the font color for the Load More 

Load More Font Hover Color: Select Load More font hover color for gallery images/videos

Load More Button Color: Change Load More button color  

Load More Background Hover Color: For the gallery images select the color of Load More background hover 

Loading Animation 1: There are 4 types of animation for the gallery images and videos
...
Slider Background Color: Set the background color for Slider  in the gallery
...
Title Font Size: Set the font size of the title of the gallery images

Title Font Color: Set the color of the font of the gallery images


*   **Link Button**

Show Link Button: Click to show the link button in gallery

Link Button Text:  Change the text on the link button in gallery

Link Button Font Size:  Change the font size of the link text 

Link Button Font Color: Change the color for the link text

Link Button Font Hover Color: Change the color for the link text while hovering on it in Image Gallery plugin

Link Button Background Color: Choose the color for  link background 

Link Button Background Hover Color: Choose the color for the  link background while hovering on it 
...
Image Width:  Set the size of the image of the gallery

Image Border Width: Set the width of borders of the image gallery
...
Title Font Size: Set the font size of the title on the gallery images

Title Font Color: Set the color of the title of the gallery images

Title Font Hover Color: Set the color of the title while hovering on it 

Title Background Color: Choose the title background color of the gallery images

Title Background Transparency: Choose the level of title background transparency in the gallery
...
Image Behaviour: Choose resized if you need your gallery images have the size of the slider
...
Title Border Size: Set the size of the title border for the gallery

Title Border Color: Choose the color for the title border of the gallery

Title Border Radius: Set the radius for border corners 

Title Position: Choose the position for the title on the images 
...
Description Background Color:  Choose the color for description background when open your gallery images

Description Border Size:  Set the size for the border in description 

Description Border Color: Set gallery image description border color 
...
Navigation Dots Color: Choose the color for navigation dots on the images of the gallery

Navigation Active Dot Color: Choose the color of moving dots for the gallery image
...
Image Width: Set the width of thumbnail of your gallery 

Image Height: Set the height of thumbnail of your gallery 
...
Title Background Transparency:  Set the level of background transparency for the gallery
...
Image Justify: Select to make the width of all gallery image/video up to 100% in container. So, they all together will fit into the container of your theme, and tick off to bring each of them with it’s natural size
...
Show Title: Select, if you need to display the title of the project of the gallery

Font Size: Choose title font size for the gallery images

Font Color: Decide font color for the title for the gallery images
...
Text Align: Choose text align for title for the gallery


*   **Description Styles*

Show Description:  Select whether to see the description text or not on the images of  the gallery

Font Size: Change the font size for the description of the gallery images
...
Text Align: Choose the text align for description of the gallery images
...
The commercial version users of Image Gallery, can do unlimited customization, according to their demand and need. So, if your gallery images/videos open with lightbox, in Lightbox Options do all the necessary changes.
...
Transition type: Select among 3 transition type:Elastic, Fade or None for showing your gallery images/videos

Opening speed: Set the lightbox opening speed for your gallery images/videos 

Closing speed: Set the lightbox closing speed for the images/videos in the gallery 

Show the title: Tick to show the title when open your gallery content

Overlay transparency: Select the level of transparency for the image /video overlay in Image Gallery

Auto-open: If need the lightbox open automatically your gallery images and videos just put check mark.

Overlayclose true: Put checkmark to close the lightbox clicking on the background  

Esc Key close: Tick to close lightbox with Esc Key for the gallery images or videos

Keyboard Navigation: Turn on to navigate your gallery images/videos  with keyboard  

Loop content: If you select loop content for the your gallery images and videos, in this case the 

Images will have endless circulation in lightbox, if not they will stop on the last image of the gallery
...
Popup width: Set the Popup width to choose the size for the images in gallery 

Popup height: Set the Popup height  to choose the size for the images in gallery 

Popup initial width: Choose the initial width when the images of your gallery opens in lightbox 

Popup initial height: Choose the initial height when the images of your gallery opens in lightbox 



Slideshow

Slideshow: Set slideshow effect for the gallery images 

Slideshow interval: Set the interval to slide the images in the gallery

Slideshow auto start: Select to start the gallery images slideshow automatically

Slideshow start button text: Change the start slideshow text on your gallery images

Slideshow stop button text: Change the stop slideshow text  on your gallery images

Positioning

Fixed position: If you need the lightbox to have fixed position just put check mark

Popup position. Choose among  9 position to open  the images of your gallery with lightbox

If you think, that you have found a bug in our [WordPress Image Gallery](http://huge-it.com/wordpress-gallery/) plugin or have any question contact us at [info@huge-it.com](mailto:info@huge-it.com)